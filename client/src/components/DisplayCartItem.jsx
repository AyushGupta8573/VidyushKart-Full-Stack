    ...
    return (
        <section className='bg-neutral-900 fixed top-0 bottom-0 right-0 left-0 bg-opacity-70 z-50'>
            <div className='bg-white w-full max-w-sm min-h-screen max-h-screen ml-auto'>
                ...
                <div className='min-h-[75vh] lg:min-h-[82vh] h-full max-h-[calc(100vh-150px)] bg-blue-50 p-2 flex flex-col gap-4'>
                    {/***display items */}
                    {
                        cartItem[0] ? (
                            <>
                                ...
                                <div className='bg-white p-4'>
                                    ...
                                    <div className='flex gap-4 justify-between ml-1'>
                                        <p>Delivery Charge :</p>
                                        <p className='line-through text-neutral-400'>{DisplayPriceInRupees(60)}</p>
                                        <p className='flex items-center font-medium'>Free</p>
                                    </div>
