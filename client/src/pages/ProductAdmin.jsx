    ...
    <section className=''>
      ...
      <div className='p-4 bg-blue-50'>
        ...
        <div className='flex justify-between my-4'>
          <button onClick={handlePrevious} className="border border-orange-200 px-4 py-1 hover:bg-orange-300 rounded">Previous</button>
          <button className='w-full bg-slate-100'>{page}/{totalPageCount}</button>
          <button onClick={handleNext} className="border border-orange-200 px-4 py-1 hover:bg-orange-300 rounded">Next</button>
        </div>
